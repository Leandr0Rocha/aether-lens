...
function Header({ busca, setBusca, buscar }) {
  return (
    <header className="w-full h-24 flex flex-1 items-center justify-around p-4 sm:p-2 md:px-6 relative z-40 max-[480px]:h-16 max-[480px]:p-1 mb-2">
      <Menu />
      <Logo />
      <form
        onSubmit={buscar}
      ...
      >
        <input
          ...
          className="bg-black text-white rounded-l-md p-4 focus:outline-none md:w-64 sm:w-36 shadow hover:bg-gray transition font-[Michroma] max-[480px]:p-2 max-[480px]:text-xs max-[480px]:w-24"
          value={busca}
